...
; 0x0 CrossDevice
; CHECK-SPIRV: Constant [[UINT]] [[CD:[0-9]+]] 0

; CHECK-SPIRV: Constant [[UINT]] [[ID1:[0-9]+]] 2
; CHECK-SPIRV: Constant [[UINT]] [[ID2:[0-9]+]] 4
; CHECK-SPIRV: Constant [[UINT]] [[ID3:[0-9]+]] 8
; CHECK-SPIRV: Constant [[UINT]] [[ID4:[0-9]+]] 16
