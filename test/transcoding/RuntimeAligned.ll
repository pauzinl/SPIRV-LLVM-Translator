...
; CHECK-SPIRV: 2 Capability RuntimeAlignedAttributeINTEL
; CHECK-SPIRV: 8 Extension "SPV_INTEL_runtime_aligned"
...
; CHECK-SPIRV-NOT: Decorate [[#ARGE]] BufferLocationINTEL [[#]]
...
; CHECK-LLVM: define spir_kernel void @test{{.*}} !kernel_arg_runtime_aligned ![[BUFLOC_MD:[0-9]+]] {{.*}}
; CHECK-LLVM: ![[BUFLOC_MD]] = !{i1 true, i1 false, i1 true, i1 false, i1 false}
